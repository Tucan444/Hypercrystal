...
class SquareModel(H2Projection):
    ...
    def project_circles(self, circles: list[H2Circle]) -> list[ProjectedCircle]:
        raise Exception("NOT SUPPORTED FOR SQUARE MODEL")
    ...
    def limit_shape(self) -> ProjectedPolygon:
        ...
        return ProjectedPolygon([
            disc.center + (offset * disc.radius)
    ...
    @classmethod
    def from_json(cls, json_data: dict) -> 'SquareModel':
        model: SquareModel = SquareModel(
